...
async def main():
    ...
    agent_config = {
        ...
        "enable_memory": False,
        "max_iterations": 20,
        "memory_dir": "/mnt/tidalfs-bdsz01/dataset/llm_dataset/shijian/evommagent/memory/20260201/blink/qwen3vl_32b/base_prompt/w_tool",
        "max_retries": 20,
    ...
    runner = Runner(
        ...
        output_dir="eval_results/20260201/dev/blink/qwen3vl_32b/direct",
        batch_size=100,
        max_concurrent=10,
        verbose=True
    )
