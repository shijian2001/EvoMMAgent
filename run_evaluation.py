...
async def main():
    ...
    agent_config = {
        ...
        "temperature": 0.7,
        "enable_memory": False,
        "memory_dir": "/mnt/tidalfs-bdsz01/dataset/llm_dataset/shijian/evommagent/memory/20260227/retrieve_exp/meta_test/blink/qwen3vl_32b/w_state_retrieve",
        "max_iterations": 20,
        "max_retries": 20,
        "mm_agent_template_en_file": "exp_prompt/more_tool_call/en.jinja2",
        "mm_agent_template_zh_file": "exp_prompt/more_tool_call/zh.jinja2",
    ...
    runner = Runner(
        ...
        output_dir="eval_results/20260227/retrieve_exp/meta_test/blink/qwen3vl_32b/w_state_retrieve",
        batch_size=100,
        max_concurrent=10,
        verbose=True
    )
