...
async def main():
    ...
    #     "enable_memory": False,
    #     "max_iterations": 20,
    #     "memory_dir": "/mnt/tidalfs-bdsz01/dataset/llm_dataset/shijian/evommagent/memory/exp_20250228/meta_test/vstar/qwen3vl_32b/w_tool",
    #     "max_retries": 20,
    ...
    runner = Runner(
        jsonl_path="data/eval/image/id/VStar/vstar_data_meta_test.jsonl",
        image_dir="data/eval/image/id/VStar/images",
        agent_config=agent_config,
        output_dir="eval_results/exp_20250228/meta_test/vstar/qwen3vl_32b/w_state",
        batch_size=100,
        max_concurrent=10,
        verbose=True
    )
