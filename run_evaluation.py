...
async def main():
    ...
    dataset = "mmsi"
    dataset_jsonl = "/mnt/tidalfs-bdsz01/usr/wangshijian/EvoMMAgent/data/eval/image/ood/MMSI/mmsi_data.jsonl"
    dataset_image_dir = "/mnt/tidalfs-bdsz01/usr/wangshijian/EvoMMAgent/data/eval/image/ood/MMSI/images"
